...
DailyTimer light(LIGHT_PIN); // declaration de la minuterie sur pin 10 de l'arduino
...
{	
	...
	// param 1 choix de temporisation (TIMER_ON,TIMER_OFF)
	// param 2 = heure
	// param 3 = minute
 	...
 	//light.setValue(TIMER_ON, 600); 		// 10:00
 	//light.setValue(TIMER_OFF , 1320);	// 22:00
